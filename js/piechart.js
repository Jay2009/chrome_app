...
console.log("your total score is : " + totalScore);
  ...
  spanScoreA.innerText = '미국 주식 점수 : ' + scoreOfA +'점 / 40점';
  spanScoreB.innerText = '한국 주식 점수 : ' + scoreOfB +'점 / 20점';
  spanScoreC.innerText = '중국 주식 점수 : ' + scoreOfC +'점 / 10점';
  spanScoreD.innerText = '신흥국 주식 점수 : ' + scoreOfD +'점 / 10점';
  spanScoreE.innerText = '안전 자산 점수 : ' + scoreOfE +'점 / 10점';
